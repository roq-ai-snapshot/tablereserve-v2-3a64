      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl id="preference_key" mb="4" isInvalid={!!formik.errors?.preference_key}>
              <FormLabel>Preference Key</FormLabel>
              <Input
                type="text"
                name="preference_key"
                value={formik.values?.preference_key}
                onChange={formik.handleChange}
              />
              {formik.errors.preference_key && <FormErrorMessage>{formik.errors?.preference_key}</FormErrorMessage>}
            </FormControl>
